...
**Last Updated:** August 13, 2026 — point values retained but marked **no longer comparable** with MVP-1's sizing, which moved to hours *(earlier same day: split out of [`../../MVP-1/DevelopmentPlan/FlatWireJiraStories.md`](../../MVP-1/DevelopmentPlan/FlatWireJiraStories.md); story bodies otherwise April 30, 2026)*
...
>
> [`../ProjectPlan/05-Backlog-MVP2.md`](../ProjectPlan/05-Backlog-MVP2.md) already carries **all six of these stories** as
...
[`ShopfloorPlan/phase-02-pass-schedule-management.md`](./ShopfloorPlan/phase-02-pass-schedule-management.md) and
[`ShopfloorPlan/phase-11-mvp2-shift-summary.md`](./ShopfloorPlan/phase-11-mvp2-shift-summary.md).
...
[`../../MVP-1/DevelopmentPlan/CapacityAndEffortModel.md`](../../MVP-1/DevelopmentPlan/CapacityAndEffortModel.md) §3b and
[`../../MVP-1/DevelopmentPlan/DevelopmentEffortModel.md`](../../MVP-1/DevelopmentPlan/DevelopmentEffortModel.md) §3.
...
>
> **Build `FW-013` to [`../RequirementDocuments/PassScheduleGenerationSpec.md`](../RequirementDocuments/PassScheduleGenerationSpec.md) v1.5**, which is the **engineering basis and wins on physics *and* arithmetic**. The criteria above are the April narrative and are wrong on five counts, the same five that make master-spec `FR-381`/`FR-384`–`FR-387` wrong (arbitrated in `FlatWire_MasterSpecification.md` §10.5):
>
...
> Its owning specification is [`../RequirementDocuments/ShiftSummary.md`](../RequirementDocuments/ShiftSummary.md), and
...
| [`../../MVP-1/DevelopmentPlan/FlatWireJiraStories.md`](../../MVP-1/DevelopmentPlan/FlatWireJiraStories.md) | The **35 MVP-1 shopfloor stories / 147 points** these were split from, the points legends, and the sprint → phase crosswalk these dead Sprint tags resolve through |
