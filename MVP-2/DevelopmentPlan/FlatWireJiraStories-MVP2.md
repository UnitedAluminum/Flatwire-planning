...
**Last Updated:** August 13, 2026 — point values retained but marked **no longer comparable** with MVP-1's sizing, which moved to hours *(earlier same day: split out of [05-SprintPlanAndBacklog.md](../../MVP-1/ProjectPlan/Development/SprintPlan.md); story bodies otherwise April 30, 2026)*
...
| [05-SprintPlanAndBacklog.md](../../MVP-1/ProjectPlan/Development/SprintPlan.md) | The **35 MVP-1 shopfloor stories / 147 points** these were split from, the points legends, and the sprint → phase crosswalk these dead Sprint tags resolve through |
