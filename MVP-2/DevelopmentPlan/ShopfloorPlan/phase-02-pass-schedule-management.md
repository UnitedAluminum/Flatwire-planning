...
> **Part of the [Flat Wire Mill — Master Implementation Roadmap](../../../MVP-1/ProjectPlan/Development/Roadmap.md).** See [Foundations](../../../MVP-1/ProjectPlan/Architecture/Architecture.md) for §0.2–0.4 shared context.
> **Prev:** [Phase 1 — Core Platform Setup](../../../MVP-1/ProjectPlan/Development/Roadmap.md) · **Next:** [Phase 3 — Line Status Board & Real-Time Backbone](../../../MVP-1/ProjectPlan/Development/Phases/phase-03-line-status-board-realtime-backbone.md)
>
> *Rod receiving and order planning/line scheduling (originally planned as separate phases) are handled upstream by the existing CoilReceiving / Planning / Scheduling systems and are out of shopfloor scope — see the [master index](../../../MVP-1/ProjectPlan/Development/Roadmap.md).*
>
...
**Owner:** **FE + BE** (stream) — *named owner TBD, see [Capacity & Effort Model](../../../MVP-1/ProjectPlan/Development/CapacityAndEffortModel.md#1-delivery-streams-and-roster) §1*
