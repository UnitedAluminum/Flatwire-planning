...
- [`Development/GapsRegister.md`](../MVP-1/ProjectPlan/Development/GapsRegister.md) — dependency chain, milestone calendar, gaps register
...
- [`02-SRS.md`](../MVP-1/ProjectPlan/Business/BusinessRequirements.md) — the OEE screen references and inventory rows *(§5.16/§5.17 for DB7/DB7b were restored on 11 Aug 2026 and are current)*
