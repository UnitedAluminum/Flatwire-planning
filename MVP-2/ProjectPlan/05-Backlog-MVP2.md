...
Rod check-in *acknowledges a pass schedule and pushes PLC tags from it*. Deferring `FW-010` does not remove that from MVP-1 — it removes the thing MVP-1 acknowledges. Resolving this is one of the open consequences in [`../README.md`](../README.md).
