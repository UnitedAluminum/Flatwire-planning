...
status_note: "⬜ **Waiting on `FW-N03` again — its 28 Aug 2026 build was reverted on 31 Aug 2026** (wave 1); `flatWireHubUrl` is **no longer in either config file**. ⚠ One package must still be added (`G10`)"
owner:
jira:
mvp: 1
phase: "1A"
...
**Status:** ⬜ **Waiting on `FW-N03` again — its 28 Aug 2026 build was reverted on 31 Aug 2026** (wave 1); `flatWireHubUrl` is **no longer in either config file**. ⚠ One package must still be added (`G10`)
