...
**Question Ref:** Q12 — [FlatWireOpenQuestions.md](../../Analysis/FlatWireOpenQuestions.md)
**Priority:** High
...
>
> | Proposed here (May 2026) | Delivered ([`FlatWire_DDL_03_Materials.sql`](../../MVP-1/DBChanges/Schema/SQL/FlatWire_DDL_03_Materials.sql)) |
> |---|---|
