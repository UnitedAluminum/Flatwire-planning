...
**Sources:** [`../FlatWire_MasterSpecification.md`](../../LatestDocument/FlatWire_MasterSpecification.md) §1, §2, §9.6, §10, §11 · [`../../MVP-1/ProjectPlan/CapacityAndEffortModel.md`](CapacityAndEffortModel.md) · [`../../MVP-1/ProjectPlan/ShopfloorPlan/back-matter.md`](ShopfloorPlan/back-matter.md) · [03-HLD-and-ERDiagram.md §14](03-HLD-and-ERDiagram.md) · `BaseDocuments/` business inputs
...
| **Data model** | The standalone `FlatWireDB` schema — **28 tables** (counted from the DDL, see `[HLD §6]`) — plus the named legacy integration points in the shared databases |
...
These block the phase named. The full register (Critical, High, Medium, Low — 90+ items) is in [`../FlatWire_MasterSpecification.md`](../../LatestDocument/FlatWire_MasterSpecification.md) §11 and is carried into `[SRS §11]` and `[SP §10]`.
