...
> |---|---|
> | Spool check-in (DB5), and the Dashboard 2 / Dashboard 5 comparison | [`RocCheckin.md`](Screens/RocCheckin.md) §4.3 |
> | Spool selection ahead of check-in (DB5A) | [`SpoolQueue.md`](Screens/SpoolQueue.md) |
> | Output coil completion and the source-traceability capture (DB7) | [`OutputCoilCompletion.md`](Screens/OutputCoilCompletion.md) §4 |
> | Weight milestones, short close and the completion decision | [`SpoolCompletionNotification.md`](Screens/SpoolCompletionNotification.md) |
>
...
>
> **Authoritative source: [`Architecture/Architecture.md`](BusinessRules.md) §0.3**, decision **D-26** in [`FlatWire_MasterSpecification.md`](../../../LatestDocument/FlatWire_MasterSpecification.md) §10.2. Do not implement FM2 from this file.
...
> |---|---|
> | The Dashboard 2 / Dashboard 5 comparison | [`RocCheckin.md`](Screens/RocCheckin.md) §4.3 |
> | The Dashboard 7 source-traceability capture | [`OutputCoilCompletion.md`](Screens/OutputCoilCompletion.md) §4 |
> | Spool selection ahead of check-in | [`SpoolQueue.md`](Screens/SpoolQueue.md) |
>
