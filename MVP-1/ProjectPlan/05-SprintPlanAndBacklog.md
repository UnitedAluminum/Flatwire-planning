...
**Development window:** **17 Aug → 30 Sep 2026**, hard **Phase-1 gate 14 Aug 2026** · trial early **Oct 2026** (TBD) · production **Q4 2026** (TBD)
**Sources:** [`../FlatWire_MasterSpecification.md`](../../LatestDocument/FlatWire_MasterSpecification.md) §9 · [`CapacityAndEffortModel.md`](CapacityAndEffortModel.md) · [`ShopfloorPlan/`](ShopfloorPlan/)'s 15 MVP-1 phase specs
...
> ### ⚠ Story points are retired
>
> Sizing is in **hours** only. The **147 / 189 / 31 / 11**-point figures quoted in ~20 downstream places no longer have a source; [§7.6](#76-appendix-a--retired-point-basis) records them so those citations stay resolvable.
>
> **Story ids are frozen.** All 39 previously-published `FW-###` ids keep their numbers and titles — roughly **1,010 citations across 93 files** key on them, including `../Mockups/*.html`, `*.js` and four `.sql` seed files. New work is minted at **`FW-130`+**, above the highest previously used id (`FW-124`). Full provenance in [§7.7](#77-appendix-b--id-provenance).
...
The per-phase owner, hours, days and window table is owned by [`ShopfloorAndRealTimePlan.md`](ShopfloorAndRealTimePlan.md), which indexes the 15 phase specifications in [`ShopfloorPlan/`](ShopfloorPlan/). It was duplicated here until 13 Aug 2026.
...
The `G##` register is owned by [`ShopfloorPlan/back-matter.md`](ShopfloorPlan/back-matter.md). The blockers that stop specific stories are in §7.4.

### 10.3 Open issues by needed-by date

See §7.4, which lists them per story and per sprint, and the `OI-##` register in [`../FlatWire_MasterSpecification.md`](../../LatestDocument/FlatWire_MasterSpecification.md) §11.
