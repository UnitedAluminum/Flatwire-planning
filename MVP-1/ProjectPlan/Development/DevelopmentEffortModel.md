...
[`ClientCall_2026-07-23_SyncPlan.md`](../../../BaseDocuments/ClientCall_2026-07-23_SyncPlan.md) §"Decisions recorded on
...
[03-HLD-and-ERDiagram.md §14](../Architecture/Architecture.md) has none. *(Note: the "AI-assisted generation" in
...
> RT 24), correct since the DB13/DB14 descope of 4 Aug 2026. `Development/Roadmap.md`'s navigation table and
...
- **What AI assistance does not compress at all:** PLC commissioning (needs the controller), UAT and stakeholder
  ...
  do not yet exist, and the **33 open client questions** in `Analysis/FlatWireOpenQuestions.md`.
...
| [`Development/Roadmap.md`](Roadmap.md) | Master roadmap index — per-phase Owner/Effort summary (hand-coded basis) |
| [`Development/GapsRegister.md`](GapsRegister.md) | Week grid, milestone calendar, gaps register (**G1**) |
...
| [03-HLD-and-ERDiagram.md §14](../Architecture/Architecture.md) | Stack constraints the factors depend on — no new frameworks, team already Angular/.NET |
