...
> [`phase-11-mvp2-shift-summary.md`](../../../../MVP-2/DevelopmentPlan/ShopfloorPlan/phase-11-mvp2-shift-summary.md):
...
- **Screens:** the `reports` library. *(Dashboard 10 is **MVP-2** — see [`phase-11-mvp2-shift-summary.md`](../../../../MVP-2/DevelopmentPlan/ShopfloorPlan/phase-11-mvp2-shift-summary.md).)*
...
- **Repository:** Dapper aggregations for the reports. *(`sp_ShiftSummary` is **MVP-2** — it lives in `MVP-2/DBChanges/Schema/SQL/FlatWire_DDL_08b_Programmability.sql`, not in this scope's `08`.)*
- **Authz:** Supervisor+.
