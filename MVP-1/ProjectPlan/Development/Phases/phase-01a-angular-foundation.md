...
> **Reference context (do not restate):** [Foundations §0.2](../../Architecture/Architecture.md) (codebase map — build against `c:\UAL\ual-angular`), **§0.3** (domain cheat-sheet), **§0.4** (real-time architecture).
