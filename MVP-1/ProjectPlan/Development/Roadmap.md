...
| `MVP-1/ProjectPlan/Business/Screens/RocCheckin.md`, `RodCheckout.md`, `RodPreCheckin.md`, `SpoolQueue.md` | Check-in/checkout/spool operator flows |
| [`Business/PartialRodReCheckin.md`](../Business/PartialRodReCheckin.md) | **Design rationale, not one of the 17 specs** — moved here from `Analysis/` 11 Aug 2026 to sit beside its owners. Nothing in it is citable; rules are in `RodPreCheckin.md` §7 and `RodCheckout.md` §7.2, requirement text in `FR-043`. Audit trail for the open `Q12` |
| [`Business/Spool.md`](../Business/Spool.md) | **Domain reference, not one of the 17 specs** — moved here from `Analysis/` 11 Aug 2026 to sit beside its owners. Authoritative for *what a spool is*; its screen sections were consolidated into `RocCheckin.md` §4.3, `SpoolQueue.md` and `OutputCoilCompletion.md` §4, and **its FM2 description is superseded by `D-26`** |
| `MVP-2/RequirementDocuments/PassScheduleManagement.md` · `Business/Screens/DieChangeAndManagement.md`, `SPCCheckpoint.md`, `WeldEvent.md` · **[`Architecture/PLCTagSpecification.md`](../Architecture/PLCTagSpecification.md)** *(in `MVP-1/ProjectPlan/Architecture/`, not MVP-2 — it is `[PLC]`, the only tag map in the repo)* | Process workflows and the role matrix, which lives in `02-SRS.md` §8 and `PassScheduleManagement.md` §3.3 *(`Analysis/OperationsManager.md` was deleted 11 Aug 2026 — recoverable at `d79ce78`)*, **the PLC/OPC tag surface** *(replaced `HMIAndSCADALayout.md`, deleted 4 Aug 2026 with the DB13/DB14 descope)* |
| [`Backend/APIs.md`](../Backend/APIs.md) `[API]` | `FlatWire.API` REST surface + `FlatWireHub` contract *(was `ProjectPlan/APIContracts.md`, absorbed and deleted 13 Aug 2026)* |
...
| [`Architecture/Architecture.md`](../Architecture/Architecture.md) §14 | "Stay within the UAL stack" ADR *(was `ProjectPlan/TechStackRecommendation.md`, absorbed and deleted 13 Aug 2026)* |
