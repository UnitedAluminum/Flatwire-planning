...
The DevelopmentPlan is thorough and largely self-aware — its own [`ShopfloorPlan/back-matter.md`](GapsRegister.md) **Gaps register (G1–G36)** already tracks many of the issues below as "Open." The dominant problem is **doc split-brain**:
