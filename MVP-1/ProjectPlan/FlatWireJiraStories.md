# Flat Wire Mill — Sprint-Wise Jira Backlog (MVP-1)
...
>
> **Owns:** the sprint calendar, story bodies, story→phase→sprint assignment, per-story hours, and sequencing.
>
> **Does not own:** requirements (the phase specs in [`ShopfloorPlan/`](ShopfloorPlan/) and the specifications in [`../RequirementDocuments/`](../RequirementDocuments/) — **the owning doc wins on any disagreement**); PLC tag path strings ([`PLCTagSpecification.md`](../RequirementDocuments/PLCTagSpecification.md), cited as `[PLC]`); decisions (the `Q##` registers in [`../../Analysis/`](../../Analysis/)); and the **hours model itself**, which remains [`CapacityAndEffortModel.md`](CapacityAndEffortModel.md).
>
> **Every hour in this document is factored from `CapacityAndEffortModel.md` §2's rate card and reconciles exactly to its §3b MVP-1 columns.** No figure here is independently estimated. If §3b changes, this document is re-derived — it is not a second opinion.

> ## ⚠ Three changes from the previous version, each with consequences
>
> | # | Change | Consequence |
> |---|---|---|
> | 1 | **Story points are retired.** Sizing is in **hours** only | The **147 / 189 / 31 / 11**-point figures quoted in ~20 downstream places no longer have a source. [Appendix A](#appendix-a--retired-point-basis) records them so those citations stay resolvable |
> | 2 | **Re-derived from the phase specs**, not reorganised | 35 stories → **116**. Almost all of the increase is **Phase 1**, which carried 1,027 h against ~28 points of database-only coverage |
> | 3 | **Even two-week sprints**, `S1` starting **Mon 24 Aug** | Diverges from `05-SprintPlanAndBacklog.md` §4.2's `S0`–`S4`, which is retired. See [§1](#1-sprint-calendar) |
>
> **Story ids are frozen.** All 39 previously-published `FW-###` ids keep their numbers and titles — roughly **1,010 citations across 93 files** key on them, including `../Mockups/*.html`, `*.js` and four `.sql` seed files. New work is minted at **`FW-130`+**, above the highest previously used id (`FW-124`). Full provenance in [Appendix B](#appendix-b--id-provenance).
...
The prerequisite chain from [`ShopfloorPlan/back-matter.md`](ShopfloorPlan/back-matter.md), expressed sprint-to-sprint:
...
| `FW-061`, `FW-082` PLC tag push *(both Critical)* | `FW-010` Pass schedule data model + API | **MVP-2** — [`FlatWireJiraStories-MVP2.md`](../../MVP-2/DevelopmentPlan/FlatWireJiraStories-MVP2.md). MVP-1 only *reads* a schedule at check-in to build the push payload |
...
**Spec:** [`phase-01a-angular-foundation.md`](ShopfloorPlan/phase-01a-angular-foundation.md) · **Owner:** FE · **370 h** (FE 224 · RT 44 · QA 54 · cont. 48)
...
**Spec:** [`phase-01b-backend-foundation.md`](ShopfloorPlan/phase-01b-backend-foundation.md) · **Owner:** BE + RT · **442 h** (BE 208 · RT 112 · QA 64 · cont. 58)
...
**Spec:** [`phase-01c-database-foundation.md`](ShopfloorPlan/phase-01c-database-foundation.md) · **Owner:** DB · **215 h** (DB 156 · QA 31 · cont. 28)
...
**Spec:** [`phase-03-line-status-board-realtime-backbone.md`](ShopfloorPlan/phase-03-line-status-board-realtime-backbone.md) · **Owning specification:** [`LineStatusOverview.md`](../RequirementDocuments/LineStatusOverview.md) (DB1) · **Owner:** RT + FE · **190 h** (FE 64 · BE 16 · DB 4 · RT 40 · QA 41 · cont. 25)
...
**Spec:** [`phase-04-rod-checkin-plc-config.md`](ShopfloorPlan/phase-04-rod-checkin-plc-config.md) · **Owning specifications:** [`RocCheckin.md`](../RequirementDocuments/RocCheckin.md) (DB2) · [`RodPreCheckin.md`](../RequirementDocuments/RodPreCheckin.md) (DB2A) · **Owner:** FE + BE + RT · **255 h** (FE 60 · BE 62 · DB 28 · RT 28 · QA 36 · BA 8 · cont. 33)
...
**Spec:** [`phase-05-active-run-monitoring-gauge-trace.md`](ShopfloorPlan/phase-05-active-run-monitoring-gauge-trace.md) · **Owning specification:** [`ActiveRunMonitor.md`](../RequirementDocuments/ActiveRunMonitor.md) (DB3) · **Owner:** FE · **154 h** (FE 76 · BE 12 · DB 8 · RT 24 · QA 22 · cont. 12)
...
- [ ] **FL2 + FL3 only, not FL1** (`FR-107`/`108`/`109`). *Note: `FlatWireShopfloorDashboards.md` and `back-matter.md` state this three contradictory ways and are stale;* `RollAdjust.md` *§1.5 is the owning spec*
...
**Spec:** [`phase-07-wip-rejection-rod-checkout.md`](ShopfloorPlan/phase-07-wip-rejection-rod-checkout.md) · **Owning specifications:** [`WipRejection.md`](../RequirementDocuments/WipRejection.md) (DB8) · [`RodCheckout.md`](../RequirementDocuments/RodCheckout.md) (DB12) · **Owner:** FE + BE · **205 h** (FE 64 · BE 40 · DB 28 · RT 16 · QA 30 · cont. 27)
...
**Spec:** [`phase-08-fl2-spool-checkin-finishing-run.md`](ShopfloorPlan/phase-08-fl2-spool-checkin-finishing-run.md) · **Owning specifications:** [`SpoolQueue.md`](../RequirementDocuments/SpoolQueue.md) (DB5A) · [`RocCheckin.md`](../RequirementDocuments/RocCheckin.md) §4.3 (DB5) · [`SpoolCompletionNotification.md`](../RequirementDocuments/SpoolCompletionNotification.md) · **Owner:** FE + BE · **118 h** (FE 48 · BE 18 · DB 12 · RT 8 · QA 17 · cont. 15)
...
**Spec:** [`phase-09-output-coil-completion-labeling-packing.md`](ShopfloorPlan/phase-09-output-coil-completion-labeling-packing.md) · **Owning specification:** [`OutputCoilCompletion.md`](../RequirementDocuments/OutputCoilCompletion.md) v1.1 (owns **DB7 and DB7b**) · **Owner:** FE + BE · **222 h** (FE 104 · BE 26 · DB 16 · RT 8 · QA 31 · BA 8 · cont. 29)
...
**Spec:** [`phase-10-fl3-hybrid-continuous-operation.md`](ShopfloorPlan/phase-10-fl3-hybrid-continuous-operation.md) · **Owner:** BE + FE · **61 h** (FE 12 · BE 20 · DB 4 · RT 8 · QA 9 · cont. 8)
...
**Spec:** [`phase-11-shift-summary-reporting-certification.md`](ShopfloorPlan/phase-11-shift-summary-reporting-certification.md) · **Owner:** BE + FE · **MVP-1 175 h** (FE 40 · BE 56 · DB 20 · RT 4 · QA 24 · BA 8 · cont. 23)
...
**Spec:** [`phase-12-yield-cost-ledger-scrap.md`](ShopfloorPlan/phase-12-yield-cost-ledger-scrap.md) · **Phase sheet:** [`YieldCostAndScrapSheet.md`](YieldCostAndScrapSheet.md) · **Owner:** BE · **177 h** (FE 44 · BE 72 · DB 12 · QA 26 · cont. 23)
...
**Spec:** [`phase-13-administration-reference-data.md`](ShopfloorPlan/phase-13-administration-reference-data.md) · **Owner:** FE + BE · **MVP-1 143 h** (FE 56 · BE 32 · DB 8 · RT 4 · QA 20 · BA 4 · cont. 19)
...
**Spec:** [`phase-14-integration-testing-plc-commissioning-golive.md`](ShopfloorPlan/phase-14-integration-testing-plc-commissioning-golive.md) · **Owner:** QA + BA · **267 h** (QA 112 · RT 40 · BA 40 · FE 16 · BE 16 · DB 8 · cont. 35)
...
# 5. Descope ladder mapped to sprints
...
Sourced from each phase file's `OQ blockers:` trailer and the gaps register in [`back-matter.md`](ShopfloorPlan/back-matter.md).
...
# Appendix A — Retired point basis
...
|---|---|---|---|
| **Shopfloor MVP-1** *(this file, previous version)* | 35 | **147** | This file's header; `ShopfloorAndRealTimePlan.md` §0.1; `REVIEW.md` #51, #57 |
...
| **Published shopfloor total** | **45** | **189** | `CapacityAndEffortModel.md` §3 cross-check; `back-matter.md` Appendix C |
...
| Document | Purpose |
|---|---|
| [`ShopfloorAndRealTimePlan.md`](ShopfloorAndRealTimePlan.md) | The master roadmap **index** — the 15 MVP-1 phase specs every story here derives from |
| [`ShopfloorPlan/00-foundations.md`](ShopfloorPlan/00-foundations.md) | §0.2 reference codebase map · §0.3 domain cheat-sheet · §0.4 real-time architecture. **Binding on every phase; do not restate it** |
| [`ShopfloorPlan/back-matter.md`](ShopfloorPlan/back-matter.md) | Dependency chain, week grid, milestone calendar, and the **gaps register `G1`–`G36`** cited throughout |
