...
-- Mode B requires it per OQ-74 and Mode P requires it when the rod was welded
-- per OQ-69; Mode A does not. The PIN is never stored -- only the badge/ID.
-- ============================================================
...
VALUES
    ...
    -- Mode B: mid-run, footage produced. Supervisor approval required (OQ-74).
