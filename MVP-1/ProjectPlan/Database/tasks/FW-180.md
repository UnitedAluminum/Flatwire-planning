...
| Concern | Owner |
|---|---|
| The **write path** | ⚠ **Backend** — [`FW-179`](../../Backend/tasks/FW-179.md) |
| `CK_SpoolCheckin_PayoffPos`'s wrong value | ⛔ [`FW-246`](FW-246.md) — `G55`, `P-163` |
| The spool this checks in | [`FW-202`](../../Backend/tasks/FW-202.md) — nothing else creates it |
| The FL2 null-gauge contract | [`FW-181`](../../Backend/tasks/FW-181.md) |
...
⚠ **This is the same blocker [`FW-202`](../../Backend/tasks/FW-202.md)
...
3. ⛔ **Escalate `OI-25`** — it decides AC 4's trace projection, not just downstream arithmetic
   (§2.2).
4. The write path is [`FW-179`](../../Backend/tasks/FW-179.md)'s.
