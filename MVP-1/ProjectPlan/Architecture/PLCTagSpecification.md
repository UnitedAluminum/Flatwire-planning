...
|---|---|
| [Rod Check-in](../Business/Screens/RocCheckin.md) | The acknowledgement that triggers the push, and the ordering of records before tags |
| [Rod Pre-Check-in](../Business/Screens/RodPreCheckin.md) | Staging, where **no tag is written** |
| [Rod Checkout](../Business/Screens/RodCheckout.md) | The line-state gate, the locked footage counter, and the tag clear |
| [Spool Completion](../Business/Screens/SpoolCompletionNotification.md) | The machine-stop prompt, which depends on the line-state vocabulary |
| [Pass Schedule Management](../../../MVP-2/RequirementDocuments/PassScheduleManagement.md) | The record whose contents are pushed, and the rule that approving it configures nothing |
| [Pass Schedule Generation](../../../MVP-2/RequirementDocuments/PassScheduleGenerationSpec.md) | How a schedule's values are derived — and why generation writes no tags |
| [Line Status Overview](../Business/Screens/LineStatusOverview.md) | The board that consumes line state, speed, gauge, width, payoff weight and the component-fault signal |
| [Die Change and Die Management](../Business/Screens/DieChangeAndManagement.md) | Die-life accumulation from the footage counter |
| [SPC Checkpoint](../Business/Screens/SPCCheckpoint.md) | The measurement checkpoints a die change and a roll adjust require |
