...
| **FR-161** | Must | 5.6 | **Not test-case shaped.** "Event-driven and extensible so future continuous-operation welding needs no redesign" is an architectural quality with no black-box observation | Design review against `Architecture/SignalR.md` §4 — record the verdict here, do not fake a case |
