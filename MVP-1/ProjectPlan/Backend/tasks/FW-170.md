...
status_note: "⚠ **A de-stub — four resume outcomes, and the database already enforces them**"
owner:
jira:
mvp: 1
phase: "6"
...
| `RunPauseEvent` the table | [`FW-171`](../../Database/tasks/FW-171.md), DB — ✅ **built** |
...
| `RunPauseEvent` table, `PauseDurationSeconds` computed | ✅ Built ([`FW-171`](../../Database/tasks/FW-171.md)) |
