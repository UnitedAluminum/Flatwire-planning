...
| Concern | Story |
|---|---|
| `SpoolCheckin` table + the `SpoolProcessing.OrderNo` index | [`FW-180`](../../Database/tasks/FW-180.md), DB — ✅ **built** |
...
| `SpoolCheckin` table + `OrderNo` index | ✅ Built ([`FW-180`](../../Database/tasks/FW-180.md)) |
