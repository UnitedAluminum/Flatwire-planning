...
| `FlatWireHub` | [`FW-080`](FW-080.md) | 28 h |
| The seven aggregate roots (`D-29`) | [`FW-207`](FW-207.md) | 32 h |
| The typed event contract | [`FW-149`](FW-149.md) | 16 h |
| OPC ingest + bounded channel | [`FW-N05`](FW-N05.md) | 32 h |
| The broadcast loop | [`FW-150`](FW-150.md) | 16 h |
| `PLCTagService` + `SimulatePLCTagPush` | [`FW-151`](FW-151.md) | 16 h |
| **`ITInhibitService`** — `phase-01b` **exit criterion 5** | [`FW-205`](FW-205.md) | 16 h |
...
> trial-scope stories [`FW-203`](FW-203.md) and
> [`FW-218`](FW-218.md) — twenty-two. **That set is complete and
