...
| The five in-run event tables | [`FW-171`](../../Database/tasks/FW-171.md), DB — ✅ **built** |
| The `InSpec` expression itself | [`FW-245`](../../Database/tasks/FW-245.md), DB — `G51`; **it depends on this story** |
...
entity** — [`FW-245`](../../Database/tasks/FW-245.md)
...
| **`G51`** | The persisted expression is **symmetric**; `Q22`'s bands are min/max pairs. [`FW-245`](../../Database/tasks/FW-245.md) owns the fix and **depends on this story** |
