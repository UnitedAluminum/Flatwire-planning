...
**Source mockup:** `Mockups\dashboard_2_rod_checkin.html` — port the HTML and CSS directly. *(This document originally named the **interim single-page layout** that held this filename until 11 Aug 2026; it is retired per decision **D-08** and REVIEW Tier 1 #40, and the file was **deleted 11 Aug 2026** — recoverable at `d79ce78`. The approved DB2 design is the 6-step tab wizard, which was `dashboard_2_rod_checkin - New.html` until it took the plain filename on 11 Aug 2026.)*
...
- OQ-14 (pass schedule selection mechanism) — assume "load linked schedule" always resolves to PS-1100-FL1-003
...
| [RocCheckin.md](../RequirementDocuments/RocCheckin.md) | Acknowledge flow design — 5-step sequence |
