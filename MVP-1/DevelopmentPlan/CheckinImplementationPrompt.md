...
Port the markup directly from `Mockups\dashboard_2_rod_checkin.html`. *(This document originally named the **interim single-page layout** that held this filename until 11 Aug 2026; it is retired per decision **D-08** and REVIEW Tier 1 #40, and the file was **deleted 11 Aug 2026** — recoverable at `d79ce78`. The approved wizard, `dashboard_2_rod_checkin - New.html` until 11 Aug 2026, now carries the plain filename. The structural notes below describe the retired layout — take the wizard's structure from the approved mockup.)* Key structural points:
...
- OQ-14 pass schedule selection (assume single active schedule per line)
...
- `Mockups\dashboard_2_rod_checkin.html` — Dashboard 2 complete HTML + CSS + JS *(the 6-step wizard; it was `dashboard_2_rod_checkin - New.html` until 11 Aug 2026, when it took the filename of the interim layout retired per **D-08** and deleted the same day — recoverable at `d79ce78`)*
- `C:\UAL\Flat Wire\Mockups\dashboard_5_spool_checkin.html` — Dashboard 5 complete HTML + CSS + JS
- `C:\UAL\Flat Wire\Mockups\dashboard_3_active_run.html` — the destination after check-in *(the earlier left-rail layout under this filename was withdrawn 1 Aug 2026; the surviving screen was named `dashboard_3_active_run_v2.html` until 11 Aug 2026)*
...
**Specs and contracts:**
- `c:/UAL/Flat Wire/MVP-1/DevelopmentPlan/APIContracts.md` — full API contract reference (Sprint 3 section)
- `c:/UAL/Flat Wire/MVP-1/RequirementDocuments/RocCheckin.md` — 5-step check-in flow design
- `c:/UAL/Flat Wire/MVP-1/DevelopmentPlan/CheckinImplementationPlan.md` — the plan this prompt implements
