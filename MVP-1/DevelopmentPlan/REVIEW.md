...
40. **Retired UI shape** — they port the interim grid + progress-ring layout that held the `dashboard_2_rod_checkin.html` filename until 11 Aug 2026; the approved design is the 6-step tab-wizard (`- New.html` until it took that filename on 11 Aug 2026). **Fix:** target the wizard, now `dashboard_2_rod_checkin.html`. **[P1✓ 1A]**
