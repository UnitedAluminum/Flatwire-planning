...
> RT 24), correct since the DB13/DB14 descope of 4 Aug 2026. `ShopfloorAndRealTimePlan.md`'s navigation table and
...
| [`ShopfloorAndRealTimePlan.md`](./ShopfloorAndRealTimePlan.md) | Master roadmap index — per-phase Owner/Effort summary (hand-coded basis) |
