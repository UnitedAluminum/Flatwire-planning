...
> enforce it. See `../../10-requirements/screens/RodPreCheckin.md` and SRS §4.2 `PCI001`–`PCI008`.
...
> [`RodOrderAllocation.md`](../../95-archive/design-notes/RodOrderAllocation.md) - cite it for *why*,
