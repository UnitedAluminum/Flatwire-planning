...
erDiagram
    ...
    ToolingInventoryEdger {
        int Id PK
        varchar EdgeType "Round | Square - ours, NULLable"
    ...
    ToolingInventoryEdgerGauge {
        ...
        tinyint GrooveNo "PROPOSED - the grid does not number them"
    }
    PayoffPosition {
