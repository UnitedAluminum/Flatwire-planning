...
**Registers touched:** `Q##` ([FlatWireOpenQuestions.md](../Analysis/FlatWireOpenQuestions.md)) · `OI-##` ([FlatWire_MasterSpecification.md](../LatestDocument/FlatWire_MasterSpecification.md)) · `G##` ([back-matter.md](../MVP-1/ProjectPlan/ShopfloorPlan/back-matter.md)) · `PSG-##` ([PassScheduleGenerationSpec.md](../MVP-2/RequirementDocuments/PassScheduleGenerationSpec.md)) · `PLC-Q##` ([PLCTagSpecification.md](../MVP-1/RequirementDocuments/PLCTagSpecification.md))
...
| **W8 — Programme** | [05-SprintPlanAndBacklog.md](../MVP-1/ProjectPlan/05-SprintPlanAndBacklog.md), [CapacityAndEffortModel.md](../MVP-1/ProjectPlan/CapacityAndEffortModel.md), [03-HLD-and-ERDiagram.md §14](../MVP-1/ProjectPlan/03-HLD-and-ERDiagram.md) — priority order, D72, service-based throughput architecture | Not blocked — **partly executed 13 Aug**: the *AI-assisted development* decision is now costed in the new [DevelopmentEffortModel.md](../MVP-1/ProjectPlan/DevelopmentEffortModel.md) (MVP-1 development **2,242 → 1,486 h**, 4.2 developer-FTE — **1,397 h of it in that sheet and Phase 12's 89 h in [YieldCostAndScrapSheet.md](../MVP-1/ProjectPlan/YieldCostAndScrapSheet.md)**), cross-referenced from the effort model. **Still open:** priority order, D72 and the service-based throughput architecture in all three targets, and the AI basis is **not** propagated into the programme totals or the §7 staffing decision |
...
| [back-matter.md](../MVP-1/ProjectPlan/ShopfloorPlan/back-matter.md) | `G35` |
