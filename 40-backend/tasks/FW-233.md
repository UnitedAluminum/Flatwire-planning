...
status_note: "⛔ **Blocked on `P-54`, which is `open`.** The decision is `[API]`'s and may cancel the build"
owner:
jira:
mvp: 1
phase: "4"
...
| Rod ingestion into `FlatWireDB` | [`FW-223`](FW-223.md) — `sp_IngestRodFromCoils`, a **different** mechanism |
| Rod ↔ order entities | [`FW-240`](FW-240.md) |
...
| `[API §4.3]`, `[API §4.20]` | `../APIs.md` | ⛔ **Specified, with no owning controller** |
