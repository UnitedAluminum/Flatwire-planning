...
id: FW-219
legacy_id:
title: FL2/FL3 run-end write-back into the shared schema
status: not-started
status_confirmed: false
status_note: "**Ready to build — the procedure is drafted and structurally verified; three values need IT sign-off before a shared environment**"
owner:
jira:
mvp: 1
phase: "9"
...
hours: 40
sprint: S3
depends_on: [FW-066, FW-141, FW-142, FW-144]
blocked_by: [OI-114, Q34, Q35, Q36]
has_plan: true
started:
completed:
---
...
**Artifact:** [`../../30-database/scripts/50_FlatWireDB_Proc_FlatWire_CompleteCoilOnSkid.sql`](../../30-database/scripts/50_FlatWireDB_Proc_FlatWire_CompleteCoilOnSkid.sql)
**Gap:** `G44`
