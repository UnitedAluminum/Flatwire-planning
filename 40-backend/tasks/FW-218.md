...
status_note: "✅ **Built and verified both ways 29 Aug 2026** — four endpoints at `/sim`, 0 errors. ⛔ **The functional rows of §5 need `FW-145`**: no role claim is issued, so these routes deny today"
owner:
jira:
mvp: 1
phase: "1B"
