...
> [`FW-138`](../10-requirements/features/FS-02-backend-service-foundation.md) §5, which carries the
...
> **Two endpoints sit in [`../60-delivery/04-APIContract-MVP2.md`](../60-delivery/04-APIContract-MVP2.md)** — `POST /passschedule/generate` and `GET /shiftsummary`. **Copied verbatim.**
>
...
> [`FW-138`](../10-requirements/features/FS-02-backend-service-foundation.md) `P-54` sets out three
