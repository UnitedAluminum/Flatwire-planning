...
> [`FW-141.md`](../MVP-1/ProjectPlan/Backend/tasks/FW-141.md),
...
| `WipRejection` | `Business/Screens/WipRejection.md`, `FW-174.md` |
...
| ⚠ **`FlatWireRunRepository` is a C# class, not a table** | §1.7b(1). The one-substitution trick (`FlatWireRun` → `FlatWire_Run` also fixes `FlatWireRunDetail`) **also corrupts this identifier.** Exclude it by name in [`FW-141.md`](../MVP-1/ProjectPlan/Backend/tasks/FW-141.md) |
