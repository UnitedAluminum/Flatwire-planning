...
*This document's change log — the former Appendix B, together with the entries that followed it — lives in [`../CHANGELOG.md`](../CHANGELOG.md) under `LatestDocument/FlatWire_MasterSpecification.md`. Per repository convention there is one change log for the whole repository; no document keeps its own.*
...
> [`BusinessRequirements.md`](../MVP-1/ProjectPlan/Business/BusinessRequirements.md) self-declares as *"the
...
**Screen:** [`../MVP-2/Mockups/dashboard_die_management.html`](../MVP-2/Mockups/dashboard_die_management.html)
**SRS:** `DMG001`–`DMG017`
...
**Screen:** [`../MVP-2/Mockups/dashboard_9_pass_schedule.html`](../MVP-2/Mockups/dashboard_9_pass_schedule.html)
**SRS:** `PSM001`–`PSM024`
...
> `MVP-2/RequirementDocuments/PassScheduleGenerationSpec.md` v1.5 (6 Aug 2026) contradicts them
...
**Screen:** [`../MVP-2/Mockups/dashboard_10_shift_summary.html`](../MVP-2/Mockups/dashboard_10_shift_summary.html)
**SRS:** `SHS001`–`SHS015`
...
**Screen:** [`../MVP-2/Mockups/dashboard_oee.html`](../MVP-2/Mockups/dashboard_oee.html)
**SRS:** `OEE001`–`OEE017`
...
**WIP station registration** (`MVP-1/ProjectPlan/Database/Scripts/10_CommonDB_Insert_WIPStations_FlatWire.sql`) creates:
...
| **`FR-381` / `FR-384` / `FR-385` / `FR-386` / `FR-387` — the generate-from-specs arithmetic** | **`MVP-2/RequirementDocuments/PassScheduleGenerationSpec.md` v1.5** (6 Aug 2026) | **Five direct contradictions, on physics rather than wording — see §10.5** |
...
| `SQL/FlatWire_DDL_06_ForeignKeys.sql` | — | **current — authoritative; all foreign keys in one script** (`06b` folded in 23 Aug 2026). Count: `[DBD §6.2]` | §5.9 |
...
| `DBScripts/10_CommonDB_Insert_WIPStations_FlatWire.sql` | 28 Jul 2026 (D2 revised 29 Jul) | current — Draft; `machine_type` and StationType pending sign-off | §5.12, §11 |
