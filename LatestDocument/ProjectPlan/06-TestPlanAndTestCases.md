...
**Sources:** `[SRS]` [02-SRS.md](./02-SRS.md) (what to prove) · `[API]` [04-APIContract.md](./04-APIContract.md) (contract shapes) · [`../FlatWire_MasterSpecification.md`](../FlatWire_MasterSpecification.md) §4 error paths and §11 (risk-based prioritisation) · [`phase-14-integration-testing-plc-commissioning-golive.md`](../../DevelopmentPlan/ShopfloorPlan/phase-14-integration-testing-plc-commissioning-golive.md)
