...
**Sources:** [`../10-requirements/MasterSpecification.md`](../10-requirements/MasterSpecification.md) §1, §2, §9.6, §10, §11 · [`CapacityAndEffortModel.md`](../60-delivery/CapacityAndEffortModel.md) · [`../90-registers/Gaps.md`](../90-registers/Gaps.md) · [`Architecture.md`](../20-architecture/Architecture.md) §14 · `BaseDocuments/` business inputs
**Shortcode:** `[VS]`
...
Twenty-five design, equipment and business decisions are closed and recorded in [`../10-requirements/MasterSpecification.md`](../10-requirements/MasterSpecification.md) §10, with the superseded position preserved in each case. **Do not re-open them.** The ones with the widest reach:
...
These block the phase named. The full register (Critical, High, Medium, Low — 90+ items) is in [`../10-requirements/MasterSpecification.md`](../10-requirements/MasterSpecification.md) §11 and is carried into `[REQ §11]` and `[SP §10]`.
