...
SQL_DIR = os.path.join(ROOT, '30-database', 'sql')
SCHEMA_DIR = os.path.join(ROOT, '30-database', 'schema')
DBD = os.path.join(ROOT, '30-database', 'DatabaseDesign.md')
PHASE1C = os.path.join(ROOT, '60-delivery', 'phases',
...
DEP = os.path.join(ROOT, '80-operations', 'Deployment.md')
...
C6_FATAL = (
    os.path.join('30-database', 'DatabaseDesign.md'),
    os.path.join('80-operations', 'Deployment.md'),
    os.path.join('60-delivery', 'phases',
                 'phase-01c-database-foundation.md'),
    os.path.join('30-database', 'sql',
    ...
    os.path.join('30-database', 'sql', 'MVP2-SCOPE.md'),
)
