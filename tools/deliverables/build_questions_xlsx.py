...
OPEN_REGISTER = os.path.join(ROOT, '90-registers', 'Questions.md')
DECIDED_REGISTER = os.path.join(ROOT, '90-registers', 'Decisions.md')
...
DEFAULT_OUT = os.path.join(ROOT, 'deliverables', 'FlatWire_ClientQuestions.xlsx')
