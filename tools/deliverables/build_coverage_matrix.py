...
SRS = os.path.join(ROOT, '10-requirements', 'BusinessRequirements.md')
TESTPLAN = os.path.join(ROOT, '70-testing', 'TestCases.md')
BACKLOG = os.path.join(ROOT, '60-delivery', 'TaskBreakdown.md')
