...
|---|---|
| [Active Run Monitor](./ActiveRunMonitor.md) | Produces the pause and downtime data, and the reason categories this report groups by |
| [Line Status Overview](./LineStatusOverview.md) | The live floor view; this is its retrospective counterpart |
| [SPC Checkpoint](./SPCCheckpoint.md) | Supplies the pass rate |
| [WIP Rejection](./WipRejection.md) | Supplies the rejection count and the held material |
| [Output Coil Completion](./OutputCoilCompletion.md) | Supplies coils out, weight out and skids closed |
| [Weld Event](./WeldEvent.md) | Supplies the weld counts |
| [Spool Queue](./SpoolQueue.md) | The target of the spools-on-floor navigation |
| [Rod Checkout](./RodCheckout.md) | Rods that left the line during the shift |
