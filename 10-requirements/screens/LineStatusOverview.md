...
|---|---|
| [PLC Tag Specification](../../20-architecture/PLCTagSpecification.md) | The machine tags behind this board — line state, speed, live gauge and width, payoff weight and the component-fault signal |
