...
**5** retained ids (tracked, not absorbed), per [`[SCM §2.3]`](../../90-registers/StoryConsolidationMap.md).
...
*No story maps here. This category is authored from specifications and registers, not from the backlog.*
...
Owned requirement ranges, from [`[SCM §2.2]`](../../90-registers/StoryConsolidationMap.md): **FR-001-022 · FR-270-277 · FR-280-282 · FR-500-508** (`[REQ §5.0` · `[REQ §5.12` · `[REQ §5.13` · `[REQ §5.24]`). **Cited, never restated.**
