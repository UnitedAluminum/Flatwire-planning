...
|---|---|---|---|---|---|
| `FW-225` | Rod ↔ order allocation — schema and domain model | DB·BE | ⛔ blocked | — | **Q48** |
| `FW-226` | Sequence validation — the four-tier partition | BE·FE | ⛔ blocked | — | **Q49** |
| `FW-227` | The order-boundary handoff and its notification | BE·FE | ⛔ blocked | — | **Q50** **Q51** |
| `FW-229` | Fulfilment rollup and order status | DB·BE | ⛔ blocked | — | **Q53** |
| `FW-240` | RodOrderAllocation / RodOrderConsumption domain entities | BE | ⛔ blocked | FW-207 FW-142 FW-225 | — |
| `FW-243` | D-30 — ROWVERSION on WeldEvent, RodCheckout, WipRejection | DB·BE | ⛔ blocked | FW-007 FW-142 FW-207 | — |
