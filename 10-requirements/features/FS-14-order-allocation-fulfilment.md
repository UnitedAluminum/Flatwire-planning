...
**6 stories in this category, each retained as its own file.** One activity per story. **Activities are expected to merge downward** as work proceeds — `FW-N17`/`N18`/`N19` are one rename, not three.
...
| `FW-226` | Sequence validation — the four-tier partition | BE·FE | ⛔ blocked ⚠ *inferred* | — | **G129** **Q49** |
| `FW-227` | The order-boundary handoff and its notification | BE·FE | ⛔ blocked ⚠ *inferred* | — | **G129** **Q50** **Q51** |
...
This category's 29 criteria across 6 cards are classified in
...
**6 register items cited by 4 of 6 activities** - **6 open**.

| Item | State | Blocks | What is missing |
|---|---|---|---|
| **`G129`** | ⛔ open | `FW-226` · `FW-227` | THE SHOPFLOOR MUST ENFORCE MEMBERSHIP OF AN ALLOCATION SET IT NOW HAS NOWHERE TO READ. P-54 closed on 10 Sep 2026 as opt |
