...
|---|---|
| **`D-55`** ([`[MS §10.2]`](../../../MasterSpecification.md)) | The decision this story implements, including the idle rule |
| [`ActiveRunMonitor.md §1.4a`](../../../screens/ActiveRunMonitor.md) | The idle rule in the client's own words |
...
| [`[API §4.7a]`](../../../../40-backend/APIs.md) | The published `200` shape brought level — it was **four blocks behind** the built DTO, two of them since 29 Aug |
