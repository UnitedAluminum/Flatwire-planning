...
| Concern | Story |
|---|---|
| The live telemetry stream that follows the snapshot | [`FW-150`](../../FS-04-realtime-plc-backbone/RT/FW-150.md) — built |
| `LineStatus` transitions and markers | [`FW-172`](../../FS-09-in-run-production-events/RT/FW-172.md) |
| `GET /run/active` and `gaugetrace` | [`FW-164`](../../FS-08-active-run-monitoring/BE/FW-164.md) — ⚠ **the story the header comment confuses this with** |
| The alert lifecycle behind `ActiveAlertDto` | `FW-N06` — ⚠ this endpoint **reads** alerts, it does not raise them |
| Bay staging commands | [`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md) |
...
The board goes live from [`FW-150`](../../FS-04-realtime-plc-backbone/RT/FW-150.md)'s stream after this snapshot, and
the two must agree (`P-181`). `FW-N06` owns the alert lifecycle `ActiveAlertDto` reads.
[`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md) writes the bay occupancy this reads,
and `FW-160` broadcasts its changes. `FW-N12` deletes the stub when the last throw goes.
⚠ **DB1 left MVP-1 scope**, so [`FW-164`](../../FS-08-active-run-monitoring/BE/FW-164.md) — not this —
