...
| `FW-154` | GET /lines/status and LineStatusService | BE | ⬜ not-started | FW-138 FW-141 | — |
| `FW-155` | FlatWireRun(MachineName, Status) index | DB | 🔵 in-review | FW-006 | — |
...
| `FW-N06` | Alert rules engine and the AlertRaised/AlertCleared lifecycle | RT | ⬜ not-started | FW-149 FW-150 | **OI-28** |
