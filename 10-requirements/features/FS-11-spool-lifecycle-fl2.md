...
|---|---|---|---|---|---|
| `FW-064` | Dashboard 5 — FL2 Spool Check-in | FE | ⊘ cancelled | FW-133 FW-124 FW-179 FW-081 | **OI-47** |
...
This category's 76 criteria across 13 cards are classified in
...
**11 register items cited by 8 of 13 activities** - **8 open**, **3 resolving to no register** (`G61`).
...
| **`OI-47`** | ⛔ open | `FW-064` | OQ-15 — FL2 check-in validation for hybrid-origin spools is undefined. The unified single-record FL3 schedule is settled |
| **`OQ-15`** | ⚠ no register | `FW-179` | **Retired prefix resolving to nothing** - needs retargeting or removal (`G61`) |
