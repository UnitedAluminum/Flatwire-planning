...
| The tag-path map's contents | `[PLC]`; bound by [`FW-144`](../../FS-02-backend-service-foundation/BE/FW-144.md) |
| **FL2's `null` gauge/width suppression** | [`FW-150`](FW-150.md) / [`FW-181`](../../FS-11-spool-lifecycle-fl2/RT/FW-181.md) — a **broadcast-boundary** rule (`[SIG §5.3]`, `FR-120`). **The ingest has no FL2 branch** |
...
([`FW-144 §2.1`](../../FS-02-backend-service-foundation/BE/FW-144.md), which built and validated both keys —
...
[`FW-144`](../../FS-02-backend-service-foundation/BE/FW-144.md) built the map behind **`ITagPathResolver`**
