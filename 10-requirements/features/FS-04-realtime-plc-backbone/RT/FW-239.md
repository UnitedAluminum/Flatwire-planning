...
| The post-commit dispatch machinery and the two lanes | [`FW-208`](../../FS-02-backend-service-foundation/BE/FW-208.md) — built |
| `PayoffStateChanged` as a **broadcast** | `FW-160`, Phase 4 |
| The run start itself — check-in creating `FlatWireRun` | [`FW-157`](../../FS-07-rod-checkin-plc-config/BE/FW-157.md) |
| The run end — FL2/FL3 run-end write-back | [`FW-219`](../../FS-15-shared-schema-boundary/BE/FW-219.md) |
| `LineStatus` transitions | [`FW-172`](../../FS-09-in-run-production-events/RT/FW-172.md) — and **not** the invalidation trigger (`P-125`) |
...
[`FW-157`](../../FS-07-rod-checkin-plc-config/BE/FW-157.md) raises `RunStarted` when check-in
creates the run. [`FW-219`](../../FS-15-shared-schema-boundary/BE/FW-219.md) raises `RunEnded` at the
