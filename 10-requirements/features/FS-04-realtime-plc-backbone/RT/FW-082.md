...
| The check-in orchestration that calls this | [`FW-157`](../../FS-07-rod-checkin-plc-config/BE/FW-157.md) |
| The tag-path map | `[PLC]` owns it; [`FW-144`](../../FS-02-backend-service-foundation/BE/FW-144.md) binds it |
| The FL2 push | [`FW-179`](../../FS-11-spool-lifecycle-fl2/BE/FW-179.md), Phase 8 — **FL2 tags only** |
...
| `ITagPathResolver` + the `[PLC]`-bound path table | ✅ Built ([`FW-144`](../../FS-02-backend-service-foundation/BE/FW-144.md)) |
...
> one ([`FW-144 §2.3`](../../FS-02-backend-service-foundation/BE/FW-144.md)).
...
2. Read the schedule locally (`D-31`), project the six groups into `PlcTagValue`s and pass them
   ...
   [`FW-157 §2.4`](../../FS-07-rod-checkin-plc-config/BE/FW-157.md) owns the write.
...
[`FW-144 §`P-16``](../../FS-02-backend-service-foundation/BE/FW-144.md)'s startup warning already counts
unconfirmed paths.
