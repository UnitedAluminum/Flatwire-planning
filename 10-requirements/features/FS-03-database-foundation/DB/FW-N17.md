...
> ([`06_ForeignKeys.sql`](../../../../30-database/sql/FlatWire_DDL_06_ForeignKeys.sql) says so deliberately, twice).
>
...
- **The client's own grid header for this column is "Machine Name"** —
  [`01_Lookup.sql`](../../../../30-database/sql/FlatWire_DDL_01_Lookup.sql), `ToolingInventoryDie`.
...
7. [`DatabaseDesign.md`](../../../../30-database/DatabaseDesign.md) and the 6 [`schema/`](../schema/) documents,
