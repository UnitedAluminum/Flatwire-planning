...
**17 absorbed stories**, seeded one activity each. **Activities are expected to merge downward** as work proceeds — `FW-N17`/`N18`/`N19` are one rename, not three.
...
**9 register items cited by 7 of 17 activities** - **7 open**, 1 closed but still cited, **1 resolving to no register** (`G61`).
