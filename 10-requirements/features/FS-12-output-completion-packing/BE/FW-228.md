...
| The allocation and consumption tables | [`FW-225`](../../FS-14-order-allocation-fulfilment/BE/FW-225.md) |
| The weight latches that call this | [`FW-227`](../../FS-14-order-allocation-fulfilment/FE/FW-227.md) |
...
[`FW-227`](../../FS-14-order-allocation-fulfilment/FE/FW-227.md) latches two weights from this and persists their
difference as the overrun — ⛔ **and must not latch `0` on an unknown** (`P-206`).
[`FW-225`](../../FS-14-order-allocation-fulfilment/BE/FW-225.md) owns the consumption row this
