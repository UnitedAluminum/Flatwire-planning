...
|---|---|---|
| `SPCCheckpoint` | [`FW-168`](../BE/FW-168.md) | ✅ |
| `PauseEvent` | [`FW-170`](../BE/FW-170.md) | ✅ |
| `WeldJoinEvent` | [`FW-166`](../BE/FW-166.md) | ❌ **deferred with DB2A** — ✅ its `WeldRecorded` event and broadcast handler are **already built** |
| `DieChangeEvent` | [`FW-167`](../BE/FW-167.md) / `FW-073` | ❌ deferred — ⛔ **and it has no domain event yet** (§2.0) |
| `RodCheckoutEvent` *(`FW-177`'s)* | [`FW-174`](../../FS-10-exceptions-off-ramps/BE/FW-174.md) / `FW-072` | ❌ deferred |
...
[`FW-177`](../../FS-10-exceptions-off-ramps/RT/FW-177.md). See §4 `P-45`.
...
| Domain-event plumbing | [`FW-208`](../../FS-02-backend-service-foundation/BE/FW-208.md) — ✅ **built, including the two-lane dispatch** |
...
[`FW-208`](../../FS-02-backend-service-foundation/BE/FW-208.md) owns that plumbing; this story
...
|---|---|---|
| `SpcCheckpointRecorded` | **this story** | [`FW-168`](../BE/FW-168.md) |
| `DieChangeRecorded` | **this story** | [`FW-167`](../BE/FW-167.md) — deferred from the trial |
...
[`FW-150`](../../FS-04-realtime-plc-backbone/RT/FW-150.md) sends `ComponentStatus` **on change only**, so a change
...
[`FW-239`](../../FS-04-realtime-plc-backbone/RT/FW-239.md) owns the eviction; **this re-broadcast is
...
1. ✅ **All six are typed on `IFlatWireClient`** ([`FW-149`](../../FS-04-realtime-plc-backbone/RT/FW-149.md)) —
...
3. **Declare `SpcCheckpointRecorded` and `DieChangeRecorded`** (§2.0), each carrying `MachineName`, and
   ...
   ([`FW-208`](../../FS-02-backend-service-foundation/BE/FW-208.md) `P-35`) — inert until `FW-168` and
   `FW-167` raise them.
...
7. Reconnect and group re-join are inherited from
   [`FW-080`](../../FS-04-realtime-plc-backbone/RT/FW-080.md) — **do not re-implement**.
...
[`FW-177`](../../FS-10-exceptions-off-ramps/RT/FW-177.md) covers the other two markers.
...
| ⛔ **`G67`** *(new here)* | `stagedWeights` has no eviction path, so the post-weld `PayoffWeight` re-broadcast reports the **previous** rod's percentage. Owned by [`FW-239`](../../FS-04-realtime-plc-backbone/RT/FW-239.md) |
