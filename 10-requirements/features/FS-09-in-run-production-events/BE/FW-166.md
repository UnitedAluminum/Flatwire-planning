...
| Concern | Story |
|---|---|
| The `WeldEvent` table | [`FW-171`](../DB/FW-171.md) — ✅ built |
| The `PayoffStateChanged` broadcast itself | `FW-160` — ⚠ **this story supplies the Pass-only trigger** |
| The staging commands | [`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md) — ⚠ **and `P-185`'s contradiction** |
| The weld marker on the trace | [`FW-172`](../RT/FW-172.md) |
...
| `WeldEvent` table | `04_Runs.sql` | ✅ Built (`FW-171`) — ⛔ **no `ROWVERSION`** (`D-30`, [`FW-243`](../../FS-14-order-allocation-fulfilment/BE/FW-243.md)) |
...
1. ⛔ **Resolve `P-185`** with [`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md) (§2.4)
...
| Concurrency | ⚠ `WeldEvent` has **no `ROWVERSION`** — [`FW-243`](../../FS-14-order-allocation-fulfilment/BE/FW-243.md)'s `D-30` |

---

## 6. Handoff

[`FW-172`](../RT/FW-172.md) puts the weld marker on the trace. `FW-160` broadcasts
`PayoffStateChanged` from the Pass. [`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md)
