...
| Concern | Story |
|---|---|
| The `CheckpointType` enum itself | [`FW-147`](../../FS-02-backend-service-foundation/BE/FW-147.md) — ✅ **built with five members** |
| The five in-run event tables | [`FW-171`](../DB/FW-171.md), DB — ✅ **built** |
| The `InSpec` expression itself | [`FW-245`](../../FS-03-database-foundation/DB/FW-245.md), DB — `G51`; **it depends on this story** |
...
> C# enum ([`FW-147`](../../FS-02-backend-service-foundation/BE/FW-147.md)), the TypeScript
...
entity** — [`FW-245`](../../FS-03-database-foundation/DB/FW-245.md)
...
1. ⚠ **`SpcController POST /spc` already exists** on
   [`FW-138`](../../FS-02-backend-service-foundation/BE/FW-138.md)'s shell — endpoint **21**. De-stub it.
2. `SubmitSpcCheckpoint` command, handler nested
   ([`FW-139 §2.2`](../../FS-02-backend-service-foundation/BE/FW-139.md)).
3. **Shape** validation in FluentValidation → `400`; **state** rules in the `FlatWireRun`
   aggregate → `422` ([`FW-147 §2`](../../FS-02-backend-service-foundation/BE/FW-147.md)).
...
| **`G51`** | The persisted expression is **symmetric**; `Q22`'s bands are min/max pairs. [`FW-245`](../../FS-03-database-foundation/DB/FW-245.md) owns the fix and **depends on this story** |
