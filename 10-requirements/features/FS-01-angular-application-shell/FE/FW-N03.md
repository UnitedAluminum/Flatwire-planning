...
**Unblocks:** [`FW-130`](FW-130.md) · [`FW-131`](FW-131.md) · [`FW-132`](FW-132.md) · [`FW-135`](../../FS-04-realtime-plc-backbone/RT/FW-135.md) — **four at once**
**Part of:** category [`FS-01` Angular Application Shell and Foundation](../../FS-01-angular-application-shell.md) — the parent story for this functional area
...
| The SignalR service | [`FW-135`](../../FS-04-realtime-plc-backbone/RT/FW-135.md) |
...
| ✅ **the hub path** | `flatWireHubUrl` is `FlatWire/hubs/flat-wire`, and [`FW-080 §0`](../../FS-04-realtime-plc-backbone/RT/FW-080.md) **re-mapped the service to match on 6 Sep 2026** — `Constants.Routes.Hub` is now `/hubs/flat-wire`, read by both `app.MapHub` and [`FW-145 §3.5`](../../FS-02-backend-service-foundation/BE/FW-145.md)'s `?access_token=` handler, so the two cannot drift. **Nothing is owed by this story or any other** *(this row read as owed until 7 Sep 2026 — `FW-080 §0` had flagged that the reciprocal rows were still stale)*. ⚠ What remains for `FW-135` is the **protocol**, not the path — `G105` |
