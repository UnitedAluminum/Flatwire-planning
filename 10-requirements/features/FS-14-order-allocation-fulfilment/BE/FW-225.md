...
| The four-tier sequence validation | [`FW-226`](../FE/FW-226.md) |
| The order-boundary handoff and its state machine | [`FW-227`](../FE/FW-227.md) |
| Footage-to-weight | [`FW-228`](../../FS-12-output-completion-packing/BE/FW-228.md) |
| `POST /order/{orderNo}/complete`'s host | [`FW-232`](../../FS-07-rod-checkin-plc-config/BE/FW-232.md) |
| Fulfilment rollup and order status | `FW-229`, Phase 9 |
| `G52`'s `Sole` tier | [`FW-246`](../../FS-03-database-foundation/DB/FW-246.md) — ⚠ it may cost no DDL |
...
[`FW-226`](../FE/FW-226.md) validates sequences over these allocations —
⚠ **and `G52`'s `Sole` tier is unresolved**, which is
[`FW-246`](../../FS-03-database-foundation/DB/FW-246.md)'s.
[`FW-227`](../FE/FW-227.md) runs the boundary handoff and is **gated by the same
`Q48`**. [`FW-228`](../../FS-12-output-completion-packing/BE/FW-228.md) supplies the weight each consumption
