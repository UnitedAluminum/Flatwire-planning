...
| Concern | Story |
|---|---|
| **The endpoint's controller shell** | [`FW-232`](../../FS-07-rod-checkin-plc-config/BE/FW-232.md) — 3 h, **already costed there**; this story is the handler |
| The allocation tables and invariants | [`FW-225`](../BE/FW-225.md) |
| Sequence validation | [`FW-226`](FW-226.md) |
| Footage-to-weight | [`FW-228`](../../FS-12-output-completion-packing/BE/FW-228.md) — supplies the latched weights |
| Station **release** | [`FW-221`](../../FS-15-shared-schema-boundary/DB/FW-221.md) — ⛔ **at checkout, not here** |
| Fulfilment rollup | `FW-229`, Phase 9 |
| The footage stream itself | [`FW-150`](../../FS-04-realtime-plc-backbone/RT/FW-150.md) — built |
...
| **`OrderController`** | — | ⛔ **Absent** — [`FW-232`](../../FS-07-rod-checkin-plc-config/BE/FW-232.md) |
...
⛔ **Do not call `FlatWire_ReleaseStation` here.** [`FW-221`](../../FS-15-shared-schema-boundary/DB/FW-221.md)
...
3. ⛔ **Predecessors**: [`FW-240`](../BE/FW-240.md) (entities, blocked on
   `[SVC §3.2a]`), [`FW-225`](../BE/FW-225.md) (invariants),
   [`FW-232`](../../FS-07-rod-checkin-plc-config/BE/FW-232.md) (the shell this handler hangs off).
...
6. **Two weight latches** — at the crossing and at the acknowledgement; **persist the
   ...
   [`FW-228`](../../FS-12-output-completion-packing/BE/FW-228.md), which persists **basis + factor + version**
   alongside.
...
[`FW-232`](../../FS-07-rod-checkin-plc-config/BE/FW-232.md) hosts the endpoint — ⛔ **and is blocked on `[API]`
minting the controller**. [`FW-228`](../../FS-12-output-completion-packing/BE/FW-228.md) supplies the latched
weights and their basis snapshot. `FW-229` (Phase 9) rolls fulfilment up.
[`FW-221`](../../FS-15-shared-schema-boundary/DB/FW-221.md)
