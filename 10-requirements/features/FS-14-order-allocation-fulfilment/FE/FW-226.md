...
| Concern | Story |
|---|---|
| The allocation tables and their invariants | [`FW-225`](../BE/FW-225.md) — **predecessor** |
| The entity types | [`FW-240`](../BE/FW-240.md) |
| `PinRole='Sole'`'s tier decision | ⛔ [`FW-246`](../../FS-03-database-foundation/DB/FW-246.md) — `G52`. ⚠ **May cost no DDL** (`P-165`) |
| The order-boundary handoff | [`FW-227`](FW-227.md) |
| The pre-check-in screen | `RodPreCheckin.md` (DB2A) · the staging commands are [`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md)'s |
| The check-in endpoint | [`FW-157`](../../FS-07-rod-checkin-plc-config/BE/FW-157.md) |
...
[`FW-246`](../../FS-03-database-foundation/DB/FW-246.md)'s, and its
...
⚠ **Both callers are unbuilt** — [`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md)'s
commands and [`FW-157`](../../FS-07-rod-checkin-plc-config/BE/FW-157.md)'s service. **The rule ships
...
gated by the same `Q48` as [`FW-225`](../BE/FW-225.md).
[`FW-158`](../../FS-07-rod-checkin-plc-config/BE/FW-158.md) and
[`FW-157`](../../FS-07-rod-checkin-plc-config/BE/FW-157.md) are the two call sites and must land with
this rule wired to both. [`FW-233`](../../FS-07-rod-checkin-plc-config/BE/FW-233.md) hosts `[API §4.20]`'s order set,
