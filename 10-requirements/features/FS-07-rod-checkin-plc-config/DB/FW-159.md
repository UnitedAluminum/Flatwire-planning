...
| Concern | Owner |
|---|---|
| The staging **commands** that write the table | [`FW-158`](../BE/FW-158.md) |
| The check-in that sets `Rod.Status = 'INFLAT'` | [`FW-157`](../BE/FW-157.md) |
| The shared-schema write-back | [`FW-220`](../../FS-15-shared-schema-boundary/BE/FW-220.md) — `40_`, Draft |
| Seeding `FL1PO` | [`FW-241`](../../FS-03-database-foundation/DB/FW-241.md) — ⛔ **deploy step 2, never run** |
...
| Object | Where | State |
|---|---|---|
| **`RodStaging`** | [`FlatWire_DDL_04_Runs.sql`](../../../../30-database/sql/FlatWire_DDL_04_Runs.sql) **`:74`** | ✅ **Built** |
| **`UX_RodStaging_Bay`** | [`FlatWire_DDL_07_Indexes.sql`](../../../../30-database/sql/FlatWire_DDL_07_Indexes.sql) **`:102`–`:103`** — filtered UNIQUE | ✅ **Built** |
...
| `PayoffPosition` lookup + 3 pinned rows | [`FlatWire_DDL_01_Lookup.sql`](../../../../30-database/sql/FlatWire_DDL_01_Lookup.sql) `:257`–`:285` | ✅ Built — row `3` is `TraversingTakeup (FL2)` |
...
| **`FL1PO` seeded** | deploy step 2 — [`FW-241`](../../FS-03-database-foundation/DB/FW-241.md) | ⛔ **No script.** The draft was **withdrawn 6 Sep 2026**, having never run |
...
*"`FL1PO` WIP station seeded"* is [`FW-241`](../../FS-03-database-foundation/DB/FW-241.md)'s job — **deploy
...
**[`FW-241`](../../FS-03-database-foundation/DB/FW-241.md) owns that gate.**
...
3. The write path lands with
   ...
   [`FW-157`](../BE/FW-157.md)
   (check-in + `INFLAT`).
4. AC 7 lands with [`FW-241`](../../FS-03-database-foundation/DB/FW-241.md)'s sign-off (§2.3).
