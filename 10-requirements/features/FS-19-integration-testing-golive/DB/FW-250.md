...
| The schema count guard's blind spot | [`FW-248`](../../FS-03-database-foundation/DB/FW-248.md) — sibling defect, same `S1`, found the same way |
...
[`FW-248`](../../FS-03-database-foundation/DB/FW-248.md) is the sibling tooling defect in the same sprint;
