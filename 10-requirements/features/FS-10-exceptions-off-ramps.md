...
| `FW-174` | POST /wipreject, POST /checkout and their services | BE | ⬜ not-started | FW-139 FW-176 FW-151 FW-254 | **OQ-13** **OQ-23** **G79** **G82** |
| `FW-175` | Durable supervisor pending-approval queue | BE | ⬜ not-started | FW-174 | **G7** |
| `FW-176` | WipRejection / RodCheckout tables and the shared coils carry-forwa | DB | 🔵 in-review | FW-007 FW-001 | **G24** **OI-38** **OQ-23** |
| `FW-177` | Exception broadcasts and the supervisor notification | RT | ⬜ not-started | FW-149 FW-175 | **G7** |
...
This category's 40 criteria across 7 cards were measured, and **only 7 % of the 1,222 in the
