...
**Dependencies:** [`FW-263`](FW-263.md) ✅ `done` · [`FW-151`](../../FS-04-realtime-plc-backbone/RT/FW-151.md) ✅ `done`
**Blockers:** —
...
Measured against [`FW-151 §5.1`](../../FS-04-realtime-plc-backbone/RT/FW-151.md)'s own table. **All 11 are committed.**
...
- ⚠ **`FW-263`–`FW-267` still have no rows in [`Orchestration.md`](../../../../50-frontend/spool-notification/Orchestration.md)** — a five-row
