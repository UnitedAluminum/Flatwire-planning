...
> `P-86`; corrected at source in [`FW-080`](../../FS-04-realtime-plc-backbone/RT/FW-080.md) and
> [`FW-150`](../../FS-04-realtime-plc-backbone/RT/FW-150.md), which had both taken the claim from here.
...
> because three rows in [`Orchestration.md`](../../../../50-frontend/spool-notification/Orchestration.md) and a `CHANGELOG` entry cite it.
...
which cannot both hold. They belong to [`FW-080`](../../FS-04-realtime-plc-backbone/RT/FW-080.md) (connection count) and
[`FW-150`](../../FS-04-realtime-plc-backbone/RT/FW-150.md) (cadence deviation), both of which had adopted the claim
