...
| `IFlatWireClient` and its payloads | [`FW-149`](../../FS-04-realtime-plc-backbone/RT/FW-149.md) |
| The hub the handlers send through | [`FW-080`](../../FS-04-realtime-plc-backbone/RT/FW-080.md) |
...
`PayoffStateChanged`, which [`FW-150`](../../FS-04-realtime-plc-backbone/RT/FW-150.md) sends **immediately, never in the
~100 ms batch**.
...
review note, costs nothing, and matches how [`FW-205`](../../FS-04-realtime-plc-backbone/RT/FW-205.md) `P-25`
