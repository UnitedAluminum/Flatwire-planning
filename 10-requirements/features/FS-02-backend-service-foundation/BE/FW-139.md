...
*(`04-APIContract.md` was absorbed into `../../../../40-backend/APIs.md` on 13 Aug 2026 — read `[API §3.2]`/`[API §4]`.)*
...
|---|---|---|
| The AC cites **`04-APIContract.md`** | Absorbed into `../../../../40-backend/APIs.md` on 13 Aug 2026 | `[GAP]`, the `ProjectPlan/` restructure |
