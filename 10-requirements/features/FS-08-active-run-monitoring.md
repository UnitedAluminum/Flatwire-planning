...
| `FW-081` | gauge-trace-chart live streaming, maximize and runtime source togg | FE·RT | ⬜ not-started | FW-133 FW-135 FW-150 | — |
...
| `FW-165` | sp_GetGaugeTrace | DB | 🔵 in-review | FW-007 | **G9** |
| `FW-202` | FL1 spool completion — stop confirmation, weight basis and the Spo | FE·BE·DB·RT | ⛔ blocked | FW-062 FW-081 FW-150 FW-171 FW-007 | **G34** **OI-25** **OI-45** **OI-56** **OI-75** |
| `FW-222` | Single-active-run index and the reversal flag | DB | 🔵 in-review | FW-007 | — |
