...
(function () {
  ...
  styleEl.textContent = [
    ...
    '.modal-context{display:flex;gap:18px;font-size:14px;color:var(--color-text-secondary);flex-wrap:wrap}',
    ...
    '.reason-group-label{font-size:14px;font-weight:600;color:var(--color-text-tertiary);text-transform:uppercase;letter-spacing:.5px;margin-bottom:6px;padding-left:4px}',
    ...
    '.notes-field label{display:block;font-size:14px;color:var(--color-text-secondary);margin-bottom:6px}',
    ...
    '.resume-info{background:var(--color-background-secondary);border-radius:var(--border-radius-md);padding:12px 16px;margin-bottom:18px;display:flex;gap:28px;font-size:14px}',
    '.resume-info-label{color:var(--color-text-secondary);margin-bottom:3px}',
    '.resume-info-value{font-weight:500}',
    '.section-label{font-size:14px;font-weight:600;color:var(--color-text-secondary);text-transform:uppercase;letter-spacing:.4px;margin-bottom:10px}',
    ...
    '.outcome-desc{font-size:14px;color:var(--color-text-secondary);margin-top:3px}',
