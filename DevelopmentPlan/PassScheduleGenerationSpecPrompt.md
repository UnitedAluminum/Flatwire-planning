...
>
> Write it to `LatestDocument/RequirementDocuments/PassScheduleGenerationSpec.md`.
>
...
> 2. `LatestDocument/ProjectPlan/01-VisionAndScope.md` — the FL1 / FL2 / FL3 line flows.
