...
| [Schema/SQL/FlatWire_ERDiagram_Documentation.md](../../LatestDocument/DBChanges/Schema/SQL/FlatWire_ERDiagram_Documentation.md) | Source ERD (22 tables → **21** once `Rod` is dropped per G12) |
