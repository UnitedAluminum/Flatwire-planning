...
- **Exit conditions:** run `Running`, rod `INFLAT`, PLC tags pushed, **return to Dashboard 2A** to stage the next rod (`FR-079a`; was Dashboard 3 — Q84).
...
5. **Run starts:** timer starts; Dashboard 1 → RUNNING (schedule ID shown); **return to Dashboard 2A** to stage the next rod (`FR-079a`; was Dashboard 3 — **Q84**).
