...
- **Retired DB2 UI:** Dashboard 2 uses its revised **`dashboard_2_rod_checkin - New.html`** — a guided **6-step tab-wizard** with SPC tolerance-viz and the confirm-bar gate — **not** the retired grid + progress-ring `- Old.html`.
