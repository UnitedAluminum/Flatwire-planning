...
| **Validation** | FluentValidation validators per command (e.g. FM2_6inS2 must be Active; FL3 requires Hybrid) |
...
| **Common lookup tables** | Seed `Stand` (FM1, FM2_8in, FM2_6inS1, FM2_6inS2), `Drawer` (DIE-0210…DIE-0340), `Edger` (round/square); **Alloy properties lookup** (FW-004): `Alloy, MaxReductionPerPass, SpringbackFactor, GaugeToleranceDefault, WidthToleranceDefault, SpeedRangeMinFPM, SpeedRangeMaxFPM` seeded 1100/1350/3003/5052/6061 |
