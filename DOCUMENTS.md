...
| .NET developer | `[ARC §2.2]` — **the reference rules are binding and non-obvious** — then `[SVC]`, then `[API]`. If you are building a specific story, check [`Backend/tasks/`](Backend/tasks/) first — it may already carry the build order |
