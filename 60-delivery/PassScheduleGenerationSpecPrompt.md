...
>
> Write it to `../10-requirements/screens/PassScheduleGenerationSpec.md`.
>
...
> 2. `../00-overview/VisionAndScope.md` — the FL1 / FL2 / FL3 line flows.
> 3. `../10-requirements/MasterSpecification.md` — equipment configuration and process
>    vocabulary. **Equipment sections only.**
> 4. `../10-requirements/ProcessWalkthrough.md` — the end-to-end process narrative.
> 5. `../90-registers/Questions.md` — the existing `Q##` decision register. Read it so your
