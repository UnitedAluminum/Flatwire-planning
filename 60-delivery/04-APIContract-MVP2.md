...
**Extracted from:** [`../40-backend/APIs.md`](../40-backend/APIs.md), 11 Aug 2026
...
> **Two endpoints returned to MVP-1 on 11 Aug 2026** — ~~`POST /coil/complete`~~ and ~~`GET /coil/{alpha}/label`~~ — with Phase 9, which is **wholly MVP-1**. They are the only writers of `CoilOutput` and `CoilTraceability`, and those tables carry the welding-wire certificate genealogy. See [`../40-backend/APIs.md`](../40-backend/APIs.md) §4.15–§4.16.

## What stayed in MVP-1 and applies here

Read alongside [`../40-backend/APIs.md`](../40-backend/APIs.md):
