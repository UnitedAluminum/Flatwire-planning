...
> **Owning specification:** [`ActiveRunMonitor.md`](../../10-requirements/screens/ActiveRunMonitor.md) (DB3) — authoritative on this phase's screen, including the Pause/Resume dialog (§6); the owning doc wins on any disagreement.
