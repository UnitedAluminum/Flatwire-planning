...
> **Part of the [Flat Wire Mill — Master Implementation Roadmap](../../00-overview/Roadmap.md).** See [Foundations](../../20-architecture/Architecture.md) for §0.2–0.4 shared context (esp. §0.4 real-time architecture, which this phase realises).
...
> **Owning specification:** [`LineStatusOverview.md`](../../10-requirements/screens/LineStatusOverview.md) (DB1) — authoritative on this phase's screen; the owning doc wins on any disagreement.
...
**OQ blockers:** **`PLC-Q02`** (confirm every machine tag path with the commissioning engineer — successor to the superseded PLC-Q02), GAP-8 (show pass-schedule ID on DB1 — open, low). **Stories:** FW-060, FW-080, FW-081 (chart component groundwork).
