...
> **Prev:** [Phase 1 — Core Platform Setup](../../00-overview/Roadmap.md) · **Next:** [Phase 3 — Line Status Board & Real-Time Backbone](./phase-03-line-status-board-realtime-backbone.md)
>
> *Rod receiving and order planning/line scheduling (originally planned as separate phases) are handled upstream by the existing CoilReceiving / Planning / Scheduling systems and are out of shopfloor scope — see the [master index](../../00-overview/Roadmap.md).*
>
...
> the open consequences in [`../../95-archive/design-notes/MVP-2-scope-note.md`](../../95-archive/design-notes/MVP-2-scope-note.md).
>
