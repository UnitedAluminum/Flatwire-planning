...
- [x] **OI-98** ✅ **CLOSED 3 Sep 2026, not merely progressed** — an odd final coil **ships as a single-coil skid** *"as it completes the order"*; planners target even coil counts, so this is the fallback rather than the design. Two conditions attached: whether the customer permits combined skids, and whether a second order is in queue. ⚠ **This card is not done** — its other acceptance criteria are still open. [`ClientEmail_2026-09-03_RodOrderAllocation_SyncPlan.md`](../../95-archive/source-documents/ClientEmail_2026-09-03_RodOrderAllocation_SyncPlan.md)
