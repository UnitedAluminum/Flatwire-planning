...
>
> **Authoritative source: [`../../20-architecture/Architecture.md`](../../10-requirements/BusinessRules.md) §0.3**, decision **D-26** in [`../../10-requirements/MasterSpecification.md`](../../10-requirements/MasterSpecification.md) §10.2. Do not implement FM2 from this file.
...
> **Note:** The authoritative open questions register is [FlatWireOpenQuestions.md](../../90-registers/Questions.md) — now contains 59 questions with decisions recorded. The list above is the original planning baseline (items 1–50); items 51–59 and all status updates are tracked in FlatWireOpenQuestions.md.
