...
> |---|---|
> | Spool check-in (DB5), and the Dashboard 2 / Dashboard 5 comparison | [`RocCheckin.md`](../../10-requirements/screens/RocCheckin.md) §4.3 |
> | Spool selection ahead of check-in (DB5A) | [`SpoolQueue.md`](../../10-requirements/screens/SpoolQueue.md) |
> | Output coil completion and the source-traceability capture (DB7) | [`OutputCoilCompletion.md`](../../10-requirements/screens/OutputCoilCompletion.md) §4 |
> | Weight milestones, short close and the completion decision | [`SpoolCompletionNotification.md`](../../10-requirements/screens/SpoolCompletionNotification.md) |
>
...
>
> **Authoritative source: [`../../20-architecture/Architecture.md`](BusinessRules.md) §0.3**, decision **D-26** in [`../../10-requirements/MasterSpecification.md`](../../10-requirements/MasterSpecification.md) §10.2. Do not implement FM2 from this file.
...
> |---|---|
> | The Dashboard 2 / Dashboard 5 comparison | [`RocCheckin.md`](../../10-requirements/screens/RocCheckin.md) §4.3 |
> | The Dashboard 7 source-traceability capture | [`OutputCoilCompletion.md`](../../10-requirements/screens/OutputCoilCompletion.md) §4 |
> | Spool selection ahead of check-in | [`SpoolQueue.md`](../../10-requirements/screens/SpoolQueue.md) |
>
...
> **The authoritative register is [FlatWireOpenQuestions.md](../../90-registers/Questions.md) (99 items).** The four
...
- [PassScheduleManagement.md](../../10-requirements/screens/PassScheduleManagement.md) — Spool check-in integrates with pass schedule acknowledgment
