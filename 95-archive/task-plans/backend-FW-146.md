...
| **`WRONG_STATION`** | 409 | Specified at `[API §4.5]`/`§4.6`, carries `correctMachineName`. Not a refusal and not an override (`Q24`) |

⚠ **`LINE_NOT_ELIGIBLE` is withdrawn — do not map it.** The `machineName = FL2` refusal was reversed in
