...
id: FW-143
legacy_id:
title: Serilog structured logging and the audit log
status: done
status_confirmed: false
status_note: "✅ **BUILT 27 Aug 2026** (§6) — Serilog, correlation, request logging and `IAuditLog` all land. ⚠ **The audit half still has no persistence target (§5, `P-15`)**, so AC 3 is structurally met and materially not"
owner:
jira:
mvp: 1
phase: "1B"
