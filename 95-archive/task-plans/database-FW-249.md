...
id: FW-249
legacy_id:
title: Re-derive the DB-stream total on the current basis
status: not-started
status_confirmed: false
status_note: "**Ready to start — and it must run AFTER [`FW-250`](FW-250.md)**"
owner:
jira:
mvp: 1
phase: "14"
...
**Status:** **Ready to start — and it must run AFTER [`FW-250`](FW-250.md)**
...
| Fixing the generator | [`FW-250`](FW-250.md) — a **hard predecessor** (§2.1) |
...
1. ⛔ **Confirm [`FW-250`](FW-250.md) has landed** and the
