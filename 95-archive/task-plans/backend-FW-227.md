...
id: FW-227
legacy_id:
title: The order-boundary handoff and its notification
status: blocked
status_confirmed: false
status_note: "⛔ **Blocked on `Q48`, `Q50`, `Q51`** — and `Q48` decides whether the handoff is universal at all"
owner:
jira:
mvp: 1
phase: "4"
...
| Concern | Story |
|---|---|
| **The endpoint's controller shell** | [`FW-232`](FW-232.md) — 3 h, **already costed there**; this story is the handler |
| The allocation tables and invariants | [`FW-225`](FW-225.md) |
| Sequence validation | [`FW-226`](FW-226.md) |
| Footage-to-weight | [`FW-228`](FW-228.md) — supplies the latched weights |
| Station **release** | [`FW-221`](../../30-database/tasks/FW-221.md) — ⛔ **at checkout, not here** |
| Fulfilment rollup | `FW-229`, Phase 9 |
| The footage stream itself | [`FW-150`](FW-150.md) — built |
...
| **`OrderController`** | — | ⛔ **Absent** — [`FW-232`](FW-232.md) |
...
**Only one transaction works.** ⚠ **And note the index is keyed on `Station`, not `MachineName`** —
...
⛔ **Do not call `FlatWire_ReleaseStation` here.** [`FW-221`](../../30-database/tasks/FW-221.md)
...
3. ⛔ **Predecessors**: [`FW-240`](FW-240.md) (entities, blocked on
   `[SVC §3.2a]`), [`FW-225`](FW-225.md) (invariants),
   [`FW-232`](FW-232.md) (the shell this handler hangs off).
...
6. **Two weight latches** — at the crossing and at the acknowledgement; **persist the
   ...
   [`FW-228`](FW-228.md), which persists **basis + factor + version**
   alongside.
...
[`FW-232`](FW-232.md) hosts the endpoint — ⛔ **and is blocked on `[API]`
minting the controller**. [`FW-228`](FW-228.md) supplies the latched
weights and their basis snapshot. `FW-229` (Phase 9) rolls fulfilment up.
[`FW-221`](../../30-database/tasks/FW-221.md)
