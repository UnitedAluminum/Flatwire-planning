...
**Registers touched:** `Q##` ([FlatWireOpenQuestions.md](../../90-registers/Questions.md) — **`Q87` added**, 56 → 57; `Q26`, `Q44`, `Q4` updated) · `OI-##` ([FlatWire_MasterSpecification.md](../../10-requirements/MasterSpecification.md) §11 — **`OI-121` updated**, none added). **No `G##`, no `FR-###`, no DDL, no contract, no mockup.**
...
[`OutputCoilCompletion.md`](../../10-requirements/screens/OutputCoilCompletion.md), and any field on it
...
- A **1920×1080** answer is a **re-layout of 25+ screens, not a rescale** — `Q26`'s own body says so, because
  ...
  [`phase-01a`](../../60-delivery/phases/phase-01a-angular-foundation.md)'s *"fixed 1280×1024
...
[`TaskBreakdown.md`](../../60-delivery/TaskBreakdown.md), and the 20 Aug ledger's risk list
...
> [`CapacityAndEffortModel.md`](../../60-delivery/CapacityAndEffortModel.md)'s totals are quoted
...
|---|---|---|---|
| **W1 — Registers** ✅ | [FlatWireOpenQuestions.md](../../90-registers/Questions.md) — **`Q87` added** (next free id: `Q1`–`Q86` were all occupied, no holes), header counts **56 → 57 open / 49 → 50 shopfloor**, priority index and Quick Reference log realigned; **`Q26`** given a progress note; **`Q44`** and **`Q4`** cross-referenced to `Q87` · [FlatWire_MasterSpecification.md](../../10-requirements/MasterSpecification.md) §11 — **`OI-121`** records `D1` and the confirmed wording | 2 | L |
...
| **W3 — Plans and effort** *(blocked on `A9`)* | [TaskBreakdown.md](../../60-delivery/TaskBreakdown.md) `S1`'s 24 Aug start · [CapacityAndEffortModel.md](../../60-delivery/CapacityAndEffortModel.md) §3b · [`../../60-delivery/StaffedSprintPlans.md`](../../60-delivery/StaffedSprintPlans.md) and the roadmap's milestone calendar. ⚠ **The 3,186 h / three-developer figures are quoted in roughly twenty files** — re-derive in **one additive sheet** and publish once, never by editing a total in place | 4+ | **H** |
...
| [FlatWireOpenQuestions.md](../../90-registers/Questions.md) | Authoritative `Q##` register — W1; **`Q87`** added, `Q26` / `Q44` / `Q4` updated |
| [FlatWire_MasterSpecification.md](../../10-requirements/MasterSpecification.md) | `OI-##` register §11 and the reconciliation authority — **`OI-121`** updated; **`OI-110`** corroborated by `D2` |
| [OutputCoilCompletion.md](../../10-requirements/screens/OutputCoilCompletion.md) | Owns DB7/DB7b — where **`Q87`**'s label lands once the field set is answered (W2) |
| [TaskBreakdown.md](../../60-delivery/TaskBreakdown.md) | `S1`'s **24 Aug** start, against a build that begins 31 Aug — W3, **not edited** |
| [CapacityAndEffortModel.md](../../60-delivery/CapacityAndEffortModel.md) | The **3,186 h / three-developer** baseline the re-basline replaces — W3, **not edited**; its totals are quoted in ~20 files |
| [phase-01a-angular-foundation.md](../../60-delivery/phases/phase-01a-angular-foundation.md) | *"Fixed 1280×1024 shopfloor canvas"* — the acceptance criterion **`Q26`** would overturn |
