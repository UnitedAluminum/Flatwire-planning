...
> [`../../tools/deliverables/extract_vba.py`](../../tools/deliverables/extract_vba.py); re-run it if the workbook
> is ever updated.
...
| [`../../tools/deliverables/extract_vba.py`](../../tools/deliverables/extract_vba.py) | Re-derives the `.bas` if the workbook changes |
| `../../10-requirements/BusinessRules.md` §3.3 | The alpha-format table this scheme is a third candidate against |
